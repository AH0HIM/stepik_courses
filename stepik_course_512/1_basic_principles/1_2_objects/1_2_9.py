...
#     if id(number) not in unique_number:
#         unique_number.append(id(number))
# print(len(unique_number))

unique_number = []                      # пустой список

for element in objects:                 # перебираем элементы
    unique_number.append(id(element))   # добавляем сам идентификатор объекта
print(len(set(unique_number)))          # длина множества
